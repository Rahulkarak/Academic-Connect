...
const Videos = () => {
  ...
  <VStack w={'full'}>
    ...
    <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflow={'auto'}>
        ...
        <Text>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Obcaecati impedit similique error est quibusdam ad veniam praesentium exercitationem nobis, distinctio cupiditate ullam provident, molestias dignissimos.
        </Text>
    </VStack>
  </VStack>
